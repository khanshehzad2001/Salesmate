...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Include Algolia library -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@algolia/autocomplete-theme-classic"/>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/algoliasearch/5.0.0-alpha.109/algoliasearch.umd.min.js" integrity="sha512-bMdxNGJbTrShogoBXZE/QOOnOZE6M1D0vTTZm9nKt7uj2tW4PW0Pgx6azi3QaKysAZP5/HN3ushVHvlbg3bgSg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        ...
        <!-- Axios Search library -->
        <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
        <!-- Include Select2s library -->
