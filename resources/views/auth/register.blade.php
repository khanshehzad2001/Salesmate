        ...
        <div class=" col-md-6 ml-auto mr-auto">    
            <div class="card card-register card-white">
                <div class="card-header">
                    <img class="card-img" src="{{ asset('white') }}/img/card-primary.png" alt="Card image" style="height: 280px; width: 400px;">
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-round btn-lg">{{ _('Register') }}</button>
                    </div>
                </form>
            </div>
        </div>
