...
return [
    ...
    */
    ...
    'license_key' => env('NOVA_LICENSE_KEY','mpgcla65yvjRwZ0YqrTbL5YlqEoMvipzVcDfQg0Le3gxv3tnX3'),
    ...
    */
    ...
    'brand' => [
         'logo' => public_path('images/Ecity-logo.svg'),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Nova Logout Redirect Path
    |--------------------------------------------------------------------------
    |
    | This configuration option allows you to specify the path where Nova should
    | redirect users after they logout from Nova. By default, they will be
    | redirected to the Laravel login page.
    |
    */

    'logout_redirect_path' => '/home',

    'redirect_unauthorized_to' => '/home',
